...
public class QnaServiceTest {
	...
	@Test
	public void deleteCommentTest() throws QnaException {
		doNothing().when(commentsRepository);
		assertTrue(qnaServiceImpl.deleteComment(1));
	}
	
	@Test
	public void deleteQuestionTest() throws QnaException {
		doNothing().when(questionRepository);
		assertTrue(qnaServiceImpl.deleteQuestion(1));
	}
}
